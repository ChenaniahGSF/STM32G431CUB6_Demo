...
OS_CONFIG_BEGIN
  ...
  OS_TASK_BEGIN
    ...
    OS_TASK_DEF(TASK_5MS  ,4 ,512 ,1 ,OS_AUTOSTART    ,EXTENDED ,FULL_PREEMPT)
  OS_TASK_END

  OS_EVENT_BEGIN
   OS_EVENT_DEF(EVT_BLINK_BLUE_LED        , 0x01)
   OS_EVENT_DEF(EVT_BLINK_GREEN_LED       , 0x02)
   OS_EVENT_DEF(EVT_TRIGGER_5MS_TASK      , 0x03)
  OS_EVENT_END
  ...
  OS_ALARM_BEGIN
    ...
    OS_ALARM_DEF(ALARM_5MS_TASK        ,ALARM_SET_EVENT ,EVT_TRIGGER_5MS_TASK      ,ALARM_NO_AUTOSTART ,TASK_5MS ,0)
    OS_ALARM_END
